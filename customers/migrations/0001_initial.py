# Generated by Django 4.2.3 on 2023-10-26 00:37
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client_first_name', models.CharField(blank=True, default=None, max_length=50, null=True)),
                ('client_last_name', models.CharField(blank=True, default=None, max_length=50, null=True)),
                ...
                ('client_check_mobile_phone', models.BooleanField(blank=True, default=False, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('plan_name', models.CharField(choices=[('Basic', 'Basic'), ('Standart', 'Standart'), ('Premium', 'Premium')], max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('work_order_due_date', models.DateField(default=django.utils.timezone.now)),
                ...
                ('work_order_status', models.CharField(choices=[('Cancelled', 'Cancelled'), ('In Progress', 'In Progress'), ('Completed', 'Completed')], default='In Progress', max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('billing_status', models.CharField(choices=[('Paid', 'Paid'), ('Unpaid', 'Unpaid'), ('Cancelled', 'Cancelled')], max_length=30)),
                ...
                ('ingestion_timestamp', models.DateTimeField(auto_now=True)),
                ('company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='customers.company')),
                ('plan', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='customers.plan')),
            ],
        ),
        migrations.AddField(
            model_name='user',
