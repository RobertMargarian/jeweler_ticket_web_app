...
urlpatterns = [
    ...
    path('<uuid:pk>/employee_update/', EmployeeUpdateView.as_view(), name='employee-update'),
    path('<uuid:pk>/employee_delete/', EmployeeDeleteView.as_view(), name='employee-delete'),    
]